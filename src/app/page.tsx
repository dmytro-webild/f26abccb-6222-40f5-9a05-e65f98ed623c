...
export default function LandingPage() {
  ...
  <div id="about" data-section="about">
      ...
      heading={[
        ...
        {
          type: "image",
          src: "http://img.b2bpic.net/free-photo/young-cook-putting-vegetable-plate-with-salad_23-2148040236.jpg",
          alt: "Chef",
        },
      ]}
    />
  ...
  <div id="menu" data-section="menu">
      ...
      products={[
        ...
        },
        {
          id: "4",
          brand: "Drinks",
          name: "Hibiscus Signature Mocktail",
          price: "$9",
          rating: 5,
          reviewCount: "95",
      ...
      features={[
        {
          ...
          description: "Designed for luxury dining.",
          ...
          titleImageSrc: "http://img.b2bpic.net/free-photo/interior-design-neoclassical-style-with-furnishings-decor_23-2151199366.jpg",
          buttonText: "View",
        },
        {
          title: "Outdoor Seating",
          description: "Relax in our warm atmosphere.",
          imageSrc: "http://img.b2bpic.net/free-photo/high-angle-chef-cooking_23-2148471935.jpg",
          titleImageSrc: "http://img.b2bpic.net/free-photo/high-angle-chef-slicing-ingredients-salad_23-2148471928.jpg",
          buttonText: "View",
        },
        {
          ...
          titleImageSrc: "http://img.b2bpic.net/free-photo/shrimp-linguine-pasta-with-basil-sun-dried-tomatoes_84443-94397.jpg",
          buttonText: "View",
        },
      ]}
      ...
      testimonials={[
        {
          id: "1",
          title: "Excellent!",
          quote: "The best Sudanese food I have tasted in a long time.",
          name: "Sarah Ahmed",
          role: "Food Critic",
        ...
        },
        {
          id: "2",
          title: "Luxurious",
          quote: "An incredible atmosphere paired with perfect food.",
          name: "John Doe",
          role: "Traveler",
        ...
        },
        {
          id: "3",
          title: "Amazing",
          quote: "I love the signature burger, simply unbeatable.",
          name: "Ali Hassan",
          role: "Regular Guest",
        ...
        },
        {
          id: "4",
          title: "Great Place",
          quote: "Perfect for date nights and family celebrations.",
          name: "Fatima Zara",
          role: "Influencer",
        ...
        },
        {
          id: "5",
          title: "Superb",
          quote: "The attention to detail in every dish is impressive.",
          name: "Omar Saeed",
          role: "Chef",
      ...
      faqs={[
        {
          ...
          content: "Yes, we do, but booking is recommended for weekends.",
        },
        {
          id: "f2",
          title: "Are you Halal certified?",
          content: "Yes, all our ingredients are 100% Halal.",
        },
        {
          id: "f3",
          title: "Do you have vegan options?",
          content: "Yes, we offer several delicious plant-based dishes.",
        },
      ]}
  ...
  <div id="contact" data-section="contact">
      ...
      buttons={[
        {
          text: "Email Us",
          href: "mailto:info@maprestaurant.com",
        },
      ]}
    />
  </div>
      ...
      columns={[
        {
          ...
          items: [
            {
              label: "123 Map St, City",
              href: "#",
            },
            {
              label: "info@maprestaurant.com",
              href: "mailto:info@maprestaurant.com",
            },
          ],
        },
